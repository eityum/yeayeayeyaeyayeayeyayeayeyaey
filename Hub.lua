-- Eityum Hub - Universal Script Hub with Tabs + Scroll + Credits Tab
...
-- Status label (bottom of frame)
local statusLabel = Instance.new("TextLabel", frame)
statusLabel.Size = UDim2.new(1, -16, 0, 14)
statusLabel.Position = UDim2.new(0, 8, 1, -18)
...
-- Safe loader: pcall wraps the httpget + loadstring + execute
local function runScript(name, url)
	setStatus("Loading " .. name .. "...", Color3.fromRGB(255, 200, 100))
	task.spawn(function()
		...
		if ok then
			setStatus("✓ " .. name .. " loaded", Color3.fromRGB(90, 220, 140))
		else
			setStatus("✗ " .. name .. ": " .. tostring(err), Color3.fromRGB(255, 100, 100))
			warn("[EityumHub] " .. name .. " failed: " .. tostring(err))
		end
		task.delay(3, function()
			if statusLabel.Text:find(name, 1, true) then
				setStatus("Ready", Color3.fromRGB(150, 150, 150))
			end
		end)
	end)
end
...
tabContent["Destructive"] = {
	{name = "🔧 SoundPlayer Tool", callback = function() runScript("SoundPlayer Tool", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/SoundPlayerToolEdition.lua") end},
	{name = "🔊 Sound Spammer", callback = function() runScript("Sound Spammer", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/Sound.lua") end},
	{name = "💀 Void", callback = function() runScript("Void", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/void.lua") end},
	{name = "🔨 OOB Stamper", callback = function() runScript("OOB Stamper", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/OOBStamper.lua") end},
	{name = "🔫 Gun", callback = function() runScript("Gun", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/Gun.lua") end},
}

tabContent["Tools"] = {
	{name = "♾️ Infinite Yield", callback = function() runScript("Infinite Yield", "https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source") end},
	{name = "😊 SmileyHub", callback = function() runScript("SmileyHub", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/SmileyHub.lua") end},
	{name = "🪄 WorldEdit Wand", callback = function() runScript("WorldEdit Wand", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/Wand.lua") end},
	{name = "🧱 Block Spawner", callback = function() runScript("Block Spawner", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/BlockSpawner.lua") end},
	{name = "🔧 F3X", callback = function() runScript("F3X", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/F3X%20abuse.lua") end},
}

tabContent["Unanchored"] = {
	{name = "〰️ Wiggly Stick", callback = function() runScript("Wiggly Stick", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/Stick.lua") end},
	{name = "🐍 Cobra Builder", callback = function() runScript("Cobra Builder", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/Cobra.lua") end},
	{name = "🤖 Mech Controller", callback = function() runScript("Mech Controller", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/robot.lua") end},
	{name = "🌪️ Tornado", callback = function() runScript("Tornado", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/Tornado.lua") end},
	{name = "🔮 Telekinesis", callback = function() runScript("Telekinesis", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/TelekinesisByEityum.lua") end},
	{name = "📝 Text Blocks", callback = function() runScript("Text Blocks", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/TextManipulate.lua") end},
	{name = "🍩 NeedOh", callback = function() runScript("NeedOh", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/NeedOh.lua") end},
	{name = "🔷 Shapes GUI", callback = function() runScript("Shapes GUI", "https://raw.githubusercontent.com/eityum/yeayeayeyaeyayeayeyayeayeyaey/refs/heads/main/scripts/Couhbalt.lua") end},
}

-- Shared UIS input handlers (dragging) — declared after both drag targets exist
UIS.InputChanged:Connect(function(i)
	if minDrag and (i.UserInputType == Enum.UserInputType.MouseMovement or i.UserInputType == Enum.UserInputType.Touch) then
